...
public class DeleteAdminAccount extends AppCompatActivity {
    ...
    //btn
    Button deleteAdmin, gotosettings,confirmpass;
    //edittext
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deleteAdmin = findViewById(R.id.deleteUserBtn);
        ...
        if (firebaseUser.equals("")){
            Toast.makeText(DeleteAdminAccount.this, "Something went wrong!" + "User Details are not available at the moment", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(DeleteAdminAccount.this,AdminSettingsMenu.class));
            finish();
        }else {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful())
                        {
                            ...
                            databaseReference.child(user.getUid()).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                                @Override
                                public void onSuccess(Void unused) {
                                    Toast.makeText(DeleteAdminAccount.this, "Account Deleted.", Toast.LENGTH_SHORT).show();
                                    auth.signOut();
                                    startActivity(new Intent(DeleteAdminAccount.this,Login.class));
                                }
                            });
                        }
                        else{
                            Toast.makeText(DeleteAdminAccount.this, "Account Deleted Failed", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
